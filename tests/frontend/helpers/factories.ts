...
export function makeDatabase(overrides: Partial<DatabaseInfo> = {}): DatabaseInfo {
  return {
    id: "db:Owner_42/BV1JogwzEEzD.db",
    role: "hotplug",
    name: "BV1JogwzEEzD",
    file_name: "BV1JogwzEEzD.db",
    path: "D:/data/databases/Owner_42/BV1JogwzEEzD.db",
    relative_path: "data/databases/Owner_42/BV1JogwzEEzD.db",
    exists: true,
    size_bytes: 1024,
    page_count: 8,
    page_size: 4096,
