      ...
      <div className="rounded-md border border-line bg-white shadow-soft">
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-line px-4 py-3">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button className="inline-flex h-9 items-center gap-2 rounded-md bg-ink px-3 text-sm font-medium text-white hover:bg-[#26344f] disabled:opacity-60" disabled={!hasControllableWork || isControlling} type="button" onClick={() => onControl("stop")}>
